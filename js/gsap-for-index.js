...
let tl_to_scroll_12 =gsap.timeline({scrollTrigger: {
  ...
  widthToDisplay <= 7300 ? (pinner = false, wayToPlayGsap = false, removeElement.style.display = "none", removeElement2.style.display = "flex", priseElement.style.marginTop = "-200px", triggerTlToScroll13 = ".fire-to-animate-gsap-2", startTlToScroll13 = "bottom 90%", endTlToScroll13 = "bottom 40%") : (pinner = true, wayToPlayGsap = true, removeElement.style.display = "flex", removeElement2.style.display = "none", priseElement.style.marginTop = "0px", triggerTlToScroll13 = ".fire-to-animate-gsap-1", startTlToScroll13 = "bottom 70%", endTlToScroll13 = "bottom -500%");
...
tl_to_scroll_11.to(".circle-to-animate-gsap-10", {opacity: 1, duration: 1, delay: .01, ease: "power2.inOut"})
               .to(".line-to-animate-gsap-7", {keyframes: [{ height: 0, duration: 1 },{ height: 1000, duration: 8 },]})
